...
from wayf_vision.kalman.dist_metrics import iou, dist3d, dist_ground, m_distance
...
def compute_affinity(dets, trks, metric, trk_inv_inn_matrices):
...
def data_association(dets, trks, metric, threshold, algm='greedy', \
	trk_innovation_matrix=None, info=[], trk_info=[]):   
	"""
